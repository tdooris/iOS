...
- (void)viewDidLoad
{
    ...
    self.fetchedRecipes = [appDelegate getAllRecipes];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [self.fetchedRecipes count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    Recipe *recipe = [self.fetchedRecipes objectAtIndex:indexPath.row];
...
-(IBAction) unwindToRecipes:(UIStoryboardSegue *)segue{
    ...
    if (recipe != nil){
        [self.fetchedRecipes addObject:recipe];
        [self.tableView reloadData];
    }
}
@end
